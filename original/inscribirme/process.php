...
if ($_SERVER["REQUEST_METHOD"] == "POST") {//Check it is comming from a form
  ...
  if (empty($u_postulation)){
	...
	$statement = $mysqli->prepare("INSERT INTO Usuarios (Nom, Correu, Carrecs, Contacte) VALUES(?, ?, ?, ?)"); //prepare sql insert query
	//bind parameters for markers, where (s = string, i = integer, d = double,  b = blob)
	$statement->bind_param('ssss', $u_name, $u_email, $u_postulation, $u_contact); //bind values and execute insert query

	if($statement->execute()){
		print "¡Hey " . $u_name . "! Sus datos se han recibido correctamente. ¡Gracias por participar!";
	}else{
